...
public class PARTY_HAT_CRAB_ANIMATED extends SItem implements ItemStatistics, SkullItem, Museum {

    @Override
    public String getName() {
        return "Crab Hat of Celebration - 2022 Edition";
    }
    ...
    @Override
    public String getId() {
        return "PARTY_HAT_CRAB_ANIMATED"; 
    }
