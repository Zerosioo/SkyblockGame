...
public class NETHER_STALK_DISTILLATE extends SItem implements ItemStatistics, SkullItem, Sellable {

    @Override
    public String getName() {
        return "Nether Wart Distillate";
    }
    ...
    @Override
    public String getId() {
        return "NETHER_STALK_DISTILLATE"; 
    }
